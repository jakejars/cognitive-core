#!/usr/bin/env python3
"""Compatibility entry point for S2.

Authoritative S2 evaluation is implemented by harness.confirmation_runner.
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Cognitive Core S2 runner")
